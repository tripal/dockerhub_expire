...
class dockerhub_expire {
  ...
  public function cleanupRepository(string $repository): void {
    ...
    $this->log('  Digests deleted: ' . $deleted);
...
$repositories = preg_split('/, */', $options['repositories']);

foreach ($repositories as $repository) {
  $result = $cleaner->cleanupRepository($repository);
}
